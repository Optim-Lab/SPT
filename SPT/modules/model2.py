...
The Stage 2 component is identical to the original TabSyn implementation, 

Reference:
[1] https://github.com/amazon-science/tabsyn/blob/main/tabsyn/model.py
"""
...
from modules.utils import EDMLoss
